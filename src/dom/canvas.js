    ...
    <div class="sidebar-links">
      <a href="#" class="sidebar-link">
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          <path d="M13 7A6 6 0 1 1 1 7a6 6 0 0 1 12 0Z" stroke="currentColor" stroke-width="1.5"/>
          <path d="M7 3.5v3.75l2.5 1.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
        </svg>
        Docs
      </a>
      <a href="#" class="sidebar-link">
...
function toggleCanvas(btn, sidebarBtn) {
  ...
  if (isVisible) {
    ...
    btn.querySelector('span').textContent = "Show Canvas";
    btn.classList.remove("active");
  } else {
    // Open animation - Open both canvas and sidebar
    ...
    btn.querySelector('span').textContent = "Hide Canvas";
...
function buildJSONTree(obj, level = 0) {
  ...
  for (const [key, value] of Object.entries(obj)) {
    ...
    if (isObject) {
      html += `
        <div class="json-item" style="padding-left: ${level * 16}px">
